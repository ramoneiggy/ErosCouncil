...
?>
  ...
  <head>
    ...
    <meta name="description" content="We are the council of EROTIKA, join us... We review and rate various adult sites so you can find what you are looking for ;)"
    />
  </head>
  ...
  <body>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark bg-dark-nav">
      ...
      <a class="navbar-brand" href="index.php">
        <img class="logo-nav" src="img/sexy-lady-left.png" alt="logo">
      </a>
          ...
          if (isset($_SESSION['u_id'])){?>
            ...
            if (Check::ifAdmin($_SESSION['u_id']) == 1){?>
              <a href='administration.php'>
                <button type='submit' class="btn btn-outline-purple my-2 my-sm-0" name='admin'>ADMINISTRATION</button>
              </a>
              <?php
            }
          ?>
                <a href="pornfolio.php?profile=<?php echo $_SESSION['u_uid']; ?>">
                  <button type="submit" name="profile" class="btn btn-outline-purple my-2 my-sm-0">PORNFOLIO</button>
                </a>
      ...
      &nbsp;
      <a class="navbar-brand" href="index.php">
        <img class="logo-nav" src="img/sexy-lady-right.png" alt="logo">
      </a>
    </nav>

    <div class="jumbotron">
      <h1 class="font-effect-neon display-4 blink_me">
        <b>
          <a class="header-link-white" href="index.php">EROS COUNCIL</a>
        </b>
      </h1>
