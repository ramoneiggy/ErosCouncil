...
<div class="container-fluid text-left">
    <h4 class="font-effect-neon">Welcome home <?php if (isset($_SESSION['u_id'])){echo $_SESSION['u_uid']."! How's it hangin'?";}else{echo "- please login or <a class='font-effect-neon' href='signup.php'>sign up</a>.";}?></h4>
    <?php
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">
            <h3 class="text-center font-effect-neon"><b>STAFF FAVORITES</b></h3><hr>
            <?php                
                Draw::drawListFeaturedSites();
            ?>
        </div>
        <div class="col-sm-6">
            <h3 class="text-center font-effect-neon"><b>USER RECOMENDED SITES</b></h3><hr>
