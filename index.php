...
<div class="container-fluid text-left">
    <h4>Welcome home
        <?php if($_SESSION['gender'] == 'male'){echo 'Councilman';}elseif($_SESSION['gender'] == 'female'){echo 'Councilwoman';}elseif($_SESSION['gender'] == 'other'){echo 'Councilperson';} ?>
        <?php if (isset($_SESSION['u_id'])){echo $_SESSION['u_uid']."! How's it hangin'?";}else{echo "- please login or <a class='link-black' href='signup.php'>sign up</a>.";}?>
    </h4>
    <?php
...
<div class="container-fluid">
    ...
    ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <h3 class="text-center">
                    <b>USER RECOMENDED SITES</b>
                </h3>
                <hr>
                <form class="text-center text-dark-purple" name="sortBy" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">SORT BY
                    <br>
